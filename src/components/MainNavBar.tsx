...
const MainNavBar = () => {
    return (
        <nav className="fixed top-0 left-0 w-full z-40 p-10 md:p-20 flex justify-between items-center pointer-events-none">
            {/* Logo-ul - pointer-events-auto ca să poată fi apăsat */}
