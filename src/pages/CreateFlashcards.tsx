    ...
    return (
        <div className="min-h-screen bg-base-100 flex flex-col">
            ...
            <div className="flex flex-1 pt-24 h-screen"> {/* pt-24 to account for fixed navbar */}
                ...
                <div className="w-80 bg-base-200 border-r border-base-content/10 p-6 flex flex-col h-full overflow-hidden shrink-0 z-20"> {/* Added z-20 and shrink-0 */}
                    ...
                    <div className="flex-1 overflow-y-auto space-y-3 pr-2 custom-scrollbar">
                        ...
                        {flashcards.map((card) => (
                            <div
                                ...
                                className={`group relative bg-base-200 p-4 rounded-xl border transition-all cursor-pointer ${selectedCardId === card.id
                                    ? "border-primary bg-base-200 shadow-[0_0_15px_rgba(37,99,235,0.2)]"
                                    : "border-base-content/5 hover:bg-base-200 hover:border-base-content/10"
                                    }`}
                            >
                ...
                <div className="flex-1 flex flex-col bg-base-100 relative overflow-hidden z-10">
